...
kill_miner_proc()
{
	...
	rm /usr/bin/ip6network
	rm /usr/bin/kswaped
  rm /usr/bin/irqbalanced
	rm /usr/bin/rctlcli
	rm /usr/bin/systemd-network
	rm /usr/bin/pamdicks
}
...
# because this virus flushed your iptables, you will need to rebuild your iptables after
